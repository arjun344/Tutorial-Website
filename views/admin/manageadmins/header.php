...
<html>
<head>
	<title>Admin Portal | Manage Admins</title>
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/manage_admins.css');?>">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top ">
            ...
            <div class="navbar-collapse collapse" id="navdata">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active navd"><a href="<?php echo base_url('admin_controller/manage_admins') ?>">Admins</a></li>
