...
<div class="modal fade" id="dialog-model" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <form method="POST" action="<?php echo base_url('admin_controller/delete_post');?>">
                <div class="modal-body">

                    <?php  
                 foreach ($delete_post->result() as $row)  
                 {  
                    ?>
                    <input type="hidden" name="id" value="<?php echo $row->id ;?>">
                    <input type="hidden" name="tablename" value="<?php echo $row->category_name ;?>">
