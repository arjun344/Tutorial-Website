...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/manage_users.css');?>">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top ">
            ...
            <div class="navbar-collapse collapse" id="navdata">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active navd"><a href="<?php echo base_url('admin_controller/manage_users') ?>">Users</a></li>
                </ul>
